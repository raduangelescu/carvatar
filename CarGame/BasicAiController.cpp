...
//		return;
	...
	SGenTrackNode &toSector = TRACK->getSectorPoint(m_car->getCurrentRaceSectorIdx() + 5);
	...
	if(sensorData[IS_VELOCITY] < 1.0 * (1.f-diffAngle/90.0f) && sensorData[IS_RAYCAST0] > 0.05f)
